...
export default function Home({
  ...
  return (
    <div className="w-full">
      {activeTab === "Followed" && (
        <div className="grid grid-cols-1 py-4">
          {[1, 2].map((i) => (
            <div
              key={i}
              className={`w-full mx-auto ${isDark ? "bg-gray-900" : "bg-white"
                } md:rounded-2xl md:w-3/5 border-b-2 ${isDark ? "border-gray-700" : "border-gray-200"
                }`}
            >
              ...
              <div className="font-mono py-4 px-4">Hallow</div>
      ...
      {activeTab === "Trade" && <h1>Trade</h1>}
      {activeTab === "Talk" && <h1>Talk</h1>}
    </div>
  );
}
