...
export default function NotificationPages() {
    ...
    return (
        <div
            className={`min-h-screen px-4 py-6 ${isDark ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"
                }`}
        >
            {/* Notification 1 */}
            <div
                className={`flex items-start gap-3 p-4 rounded-xl ${isDark ? "bg-gray-800" : "bg-blue-50"
                    }`}
            >
                <Image
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        AI Creator sent you a new message.
                    </p>
                </div>
