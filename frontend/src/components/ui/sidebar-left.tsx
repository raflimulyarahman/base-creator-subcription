...
export default function SidebarLeft() {
  ...
  const { role, isLoading, address } = useWallet();
        ...
        >
          ...
          {role === "Creators" ? (
            <ul className={`space-y-2 text-sm  ${
              ...
              <ul className={`space-y-2 text-sm  ${isDark ? "text-white"
                  : "text-black"
                } font-mono font-bold px-4`}>
                <li className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${ isDark ? "hover:bg-gray-800" : "hover:bg-gray-200" } transition`}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
